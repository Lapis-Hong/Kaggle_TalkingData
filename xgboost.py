...
train = pd.read_csv(train_path, skiprows=range(1, 124903891), nrows=60000000, usecols=train_columns, dtype=dtypes)
test = pd.read_csv(eval_path, usecols=test_columns, dtype=dtypes)
print('[{}] Finish loading data'.format(time.time() - start_time))
...
test = pd.read_csv(test_path, usecols=test_columns, dtype=dtypes)
